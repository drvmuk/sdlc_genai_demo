...
----------- | ---- | -------- | ------ | -----
customerdata | CSV | /Volumes/gen_ai_poc_databrickscoe/sdlc_wizard/customerdata | CSV | Customer source file
orderdata | CSV | /Volumes/gen_ai_poc_databrickscoe/sdlc_wizard/orderdata | CSV | Order source file

Appendix B: Target Definitions  
Target Name | Layer | Table | Columns | Notes
----------- | ----- | ----- | ------- | -----
ordersummary | Delta | gen_ai_poc_databrickscoe.sdlc_wizard.ordersummary | OrderId, ItemName, PricePerUnit, Qty, Date, CustId, TotalAmount, SCD Fields | SCD Type 2 implemented
customeraggregatespend | Delta | gen_ai_poc_databrickscoe.sdlc_wizard.customeraggregatespend | Name, TotalAmount, Date | Aggregated customer spend

Appendix C: Transformations  
Step | Transformation | Input | Output | Logic
---- | ------------- | ----- | ------ | -----
1 | Calculate TotalAmount | PricePerUnit, Qty | TotalAmount | TotalAmount = PricePerUnit * Qty
2 | Remove Nulls | All columns | Cleaned table | Drop rows with null values
3 | Remove Duplicates | All columns | Cleaned table | Drop duplicate rows

Appendix D: Business Rules  
Rule ID | Area | Description | Source
-------- | ----- | ----------- | ------
BR-ETL-003 | Customer | Enforce customer table schema | Documented requirement
BR-ETL-004 | Order | Enforce order table schema | Documented requirement
BR-ETL-006 | Data Quality | Remove nulls and duplicates | Documented requirement

Appendix E: Process Flow  
Step | Description | Dependency
---- | ----------- | ----------
1 | Ingest customer and order CSVs | Source files available
2 | Schema validation and cleaning | Ingestion complete
3 | Calculate TotalAmount | Clean data available
4 | Aggregate customer spend | Ordersummary table created
5 | Apply SCD Type 2 | Ordersummary table populated
6 | Output to target tables | All processing complete
