...
- Approval
  - Business Owner: Data Program Manager
  - Data Engineering Lead: Lead Data Engineer
  - Compliance Review: Data Privacy Officer
  - Date: 2024-06-12
...
customerdata | CSV | /Volumes/gen_ai_poc_databrickscoe/sdlc_wizard/customerdata | CSV | Source for customer records
orderdata | CSV | /Volumes/gen_ai_poc_databrickscoe/sdlc_wizard/orderdata | CSV | Source for order records

Appendix B: Target Definitions
Target Name | Layer | Table | Columns | Notes
ordersummary | Gold | sdlc_wizard.ordersummary | OrderId, ItemName, PricePerUnit, Qty, Date, CustId, Name, EmailId, Region, TotalAmount, EffectiveFrom, EffectiveTo, ActiveFlag | SCD Type 2 Table
customeraggregatespend | Gold | sdlc_wizard.customeraggregatespend | Name, TotalAmount, Date | Aggregate spend facts

Appendix C: Transformations
Step | Transformation | Input | Output | Logic
1 | Calculate TotalAmount | orderdata | orderdata.TotalAmount | PricePerUnit * Qty
2 | Remove Nulls/Duplicates | customerdata, orderdata | Cleaned tables | Filter out null and duplicates
3 | Apply SCD Type 2 | ordersummary | ordersummary | Track changes with EffectiveFrom/To, ActiveFlag
...
BR-ETL-003 | Customer Table | Enforce schema for CustId, Name, EmailId, Region | BRD
BR-ETL-004 | Order Table | Enforce schema for OrderId, ItemName, PricePerUnit, Qty, Date, CustId | BRD
BR-ETL-006 | Data Quality | Remove nulls and duplicates in tables | BRD

Appendix E: Process Flow
Step | Description | Dependency
1 | Load customer CSV and order CSV data | Source data files
2 | Enforce schema, clean data | Step 1
3 | Calculate TotalAmount | Step 2
4 | Populate ordersummary and apply SCD Type 2 | Step 3
5 | Aggregate customer spend to summary table | Step 4